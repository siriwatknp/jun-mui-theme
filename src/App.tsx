      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
            ...
            <Stack direction="row" spacing={3} flexWrap="wrap" useFlexGap>
              <Card sx={{ maxWidth: 345 }}>
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Cards can include actions at the bottom. These actions help
                    users interact with the card content.
                  </Typography>
                </CardContent>
                <CardActions>
              ...
              <Card sx={{ maxWidth: 345 }}>
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Actions can also be icon buttons for a more compact design.
                  </Typography>
                </CardContent>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Stack direction="row" spacing={3} flexWrap="wrap" useFlexGap>
              <Card sx={{ maxWidth: 345 }}>
                ...
                <CardContent>
                  <Typography variant="body2" color="text.secondary">
                    Cards can include headers with avatars, titles, subheaders,
                    and action buttons.
                  </Typography>
                </CardContent>
              </Card>
              ...
              <Card sx={{ maxWidth: 345 }}>
                <CardActionArea>
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Click anywhere on this card to trigger an action. Perfect
        ...
        <Box sx={{ my: 4 }}>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText id="basic-dialog-description">
                  This is a basic dialog with a title, content, and actions. It
                  can be used to display information or get user confirmation.
                </DialogContentText>
              </DialogContent>
              <DialogActions>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
              <Button variant="outlined" onClick={() => setOpenFullWidth(true)}>
                Full Width Dialog
              </Button>
              <Button
                variant="outlined"
...
Praesent commodo cursus magna, vel scelerisque nisl consectetur et.`
              ...
              <DialogActions>
                ...
                <Button onClick={() => setOpenScroll(false)}>Subscribe</Button>
              </DialogActions>
            </Dialog>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            >
              ...
              <DialogActions sx={{ p: 2 }}>
                <Button onClick={() => setOpenCustom(false)} variant="outlined">
                  Cancel
                </Button>
                <Button
                  onClick={() => setOpenCustom(false)}
            ...
            >
              ...
              <DialogActions>
                <Button onClick={() => setOpenTransition(false)}>Cancel</Button>
                <Button onClick={() => setOpenTransition(false)}>Agree</Button>
              </DialogActions>
            </Dialog>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Dialog onClose={() => setOpenList(false)} open={openList}>
              ...
              <List sx={{ pt: 0 }}>
                {["user1@example.com", "user2@example.com", "Add account"].map(
                  (email) => (
